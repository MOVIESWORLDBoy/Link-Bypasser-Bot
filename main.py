...
# bot
bot_token = os.environ.get("TOKEN", "6132913326:AAE6efOYhdl2wG8BcBrH1mKIf_KjS1I83_c")
api_hash = os.environ.get("HASH", "9c6c094150f7d097a48732c53761ec35") 
api_id = os.environ.get("ID", "28178169")
...
def send_start(client: pyrogram.client.Client, message: pyrogram.types.messages_and_media.message.Message):
    ...
    reply_markup=InlineKeyboardMarkup([[ InlineKeyboardButton("𝙐𝙋𝘿𝘼𝙏𝙀𝙎", url="https://t.me/MW_BOTS"), InlineKeyboardButton("𝙎𝙐𝙋𝙋𝙊𝙍𝙏", url="https://t.me/MW_BOTZ_SUPPORT")]]), reply_to_message_id=message.id)
